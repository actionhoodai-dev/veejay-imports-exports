    ...
    <main>
      <section className="hero-internal">
          <div className="hero-bg">
              <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=1600&auto=format&fit=crop" alt="About Us Hero" />
          </div>
